    ...
    <div>
      <div className=" flex-1 overflow-auto">
        <div className="mx-auto w-11/12 max-w-[1000px] py-10">
          ...
          {/* Delete Modal */}
          {showDeleteModal && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm over">
              <div className="relative w-full max-w-md rounded-lg bg-richblack-800 p-6 shadow-lg">
                <div className="mb-6 text-center">
                  <h3 className="mb-4 text-xl font-semibold text-richblack-5">
                ...
                <div className="flex justify-end gap-4">
                  ...
                  <button
                    ...
                    className="rounded-md bg-pink-700 px-4 py-2 text-white hover:bg-pink-400"
                  >
                    Delete Account
                  </button>
                </div>
